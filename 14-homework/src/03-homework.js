...
export {getMaxDigit, calculatePow, formatName, calculateSalary, getRandomNumber, countLetter, convertCurrency, 
    getRandomPassword, deleteLetters, isPalyndrom, deleteDuplicateLetter};
